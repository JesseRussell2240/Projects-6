...
extern uint8_t OBD2_DATA_BMS_POS;
extern uint8_t OBD2_PID_BMS_SIZE;

extern uint8_t IMD_FREQ_POS;
extern uint8_t IMD_DUTY_POS;
extern uint8_t IMD_STAT_POS;

extern uint8_t IMD_DATA_LEN;
extern uint8_t IMD_MODE;
extern uint8_t IMD_PID;
