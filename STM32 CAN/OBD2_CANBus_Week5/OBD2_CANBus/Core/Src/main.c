...
uint8_t testSend[] = { 0xAB, 0xCD, 0xEF, 0x12 };
uint8_t testRecieve[] = { 0x00, 0x00, 0x00, 0x00 };

uint8_t button1msg[] = { 0x11, 0x11, 0x11, 0x11 };
uint8_t button2msg[] = { 0x22, 0x22, 0x22, 0x22 };
uint8_t button3msg[] = { 0x33, 0x33, 0x33, 0x33 };
